...
/***************************************************************
    ...
    -> 1), 2)번을 사용하는 이유는 쓸때 없는 태그 삽입을 막는데 있다!
    -> 기존태그는 <div>,<section> 등 원래 있는 HTML태그를 말함
        (단점, 원하지 않는 태그가 삽입됨!!)
...
const myele8 = 
<h1>{txt}</h1>;
const root8 = ReactDOM.createRoot(
